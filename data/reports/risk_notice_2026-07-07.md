...
- QDII candidates in current universe snapshot: ['印度', '德国', '日经225', '中概互联网', '纳指', '沙特', '华宝油气']

## Trend Reversal Risk

Trend labels and B/S signals are rule-based summaries, not predictions. A recent uptrend can reverse before the next open.
- Weak/down candidates in current snapshot: ['中证2000', '创业板50', '可转债', '中概互联网', '纳指', '沙特', '华宝油气', '黄金']
