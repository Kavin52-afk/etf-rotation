...
- QDII candidates in current universe snapshot: ['德国', '印度', '日经225', '华宝油气', '中概互联网', '纳指', '沙特']

## Trend Reversal Risk

Trend labels and B/S signals are rule-based summaries, not predictions. A recent uptrend can reverse before the next open.
- Weak/down candidates in current snapshot: ['德国', '日经225', '中证A500', '可转债', '华宝油气', '创业板50', '中概互联网', '纳指']
